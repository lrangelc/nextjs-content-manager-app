...
// import logoPic from '../public/images/bulma.png';
// import firstPostPic from '../public/images/first-post.png';
const logoPic = '/images/bulma.png';
        ...
        <div className='container'>
          <div className='navbar-brand'>
            <a className='navbar-item' href='../'>
              <Image priority src={logoPic} alt='Logo' width={100} height={100} />
            </a>
            ...
            <div className='columns'>
              <div className='column is-8 is-offset-2'>
                <figure className='image is-16by9'>
                  <Image priority src={firstPostPic} alt='Logo' width={100} height={100} />
                </figure>
              </div>
            </div>
              ...
              <div className='columns'>
                <div className='column is-8 is-offset-2'>
                  <div className='content is-medium'>
                    ...
                    <p>
                      This is a starter template for creating a beautiful, customizable blog with minimal effort. You’ll only have to change
                      a few settings and you’re ready to go. As with all Jigsaw sites, configuration settings can be found in config
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='columns is-variable is-8'>
                <div className='column is-5 is-offset-1 '>
                  <div className='content is-medium'>
                    ...
                    <p className='has-text-dark'>
                      This starter template includes a custom 404 Not Found error page, located at /source/404.blade.php. To preview the 404
                ...
                <div className='column is-5'>
                  <div className='content is-medium'>
                    ...
                    <p className='has-text-dark'>
                      To provide fast, local search of your blog, this starter template comes with a pre-built Vue.js component that uses
